...
//pino da janela
#define PinJanCozinha 2
//pino da janela do quarto
#define PinJanQuarto 3
//pino da porta, quando porta aberta
#define PinPortaSala 4
//liga alarme porta
#define PinLigaAlarmPorta 5
//liga alarme da janela cozinha
...
#define BOT_TOKEN "Inseririr ID"

//Troque pelo ssid e senha da sua rede WiFi
#define SSID "Inserir nome da rede wifi"
#define PASSWORD "Inseriri senha da rede wifi"
...
void loop()
{
  ...
  val = digitalRead(PinJanCozinha);
  if (){
    //Envia mensagem Janela da cozinha aberta
    bot.sendMessage(chatId, "A janela da cozinha esta <b>aberta</b>", "HTML");
  }
  }
}
